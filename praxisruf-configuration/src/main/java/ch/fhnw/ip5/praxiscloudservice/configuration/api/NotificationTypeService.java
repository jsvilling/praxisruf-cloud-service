...
public interface NotificationTypeService {
     ...
     * @throws ch.fhnw.ip5.praxiscloudservice.commons.exception.PraxisIntercomException - If the ClientDto is invalid
     * @return ClientDto
     */
     ...
     * @throws ch.fhnw.ip5.praxiscloudservice.commons.exception.PraxisIntercomException - If not client with the given id exists
     * @return ClientDto
     */
     ...
     *
     * @param NotificationTypeDto
     * @throws ch.fhnw.ip5.praxiscloudservice.commons.exception.PraxisIntercomException - If the NotificationTypeDto is invalid
