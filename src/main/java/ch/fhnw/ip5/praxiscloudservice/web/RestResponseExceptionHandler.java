package ch.fhnw.ip5.praxiscloudservice.web;
...
public class RestResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    static {
        ...
        ERROR_CODE_HTTP_STATUS_MAP.put(CLIENT_CONFIG_ALREADY_EXISTS, BAD_REQUEST);
        ERROR_CODE_HTTP_STATUS_MAP.put(CLIENT_CONFIG_NOT_FOUND, NOT_FOUND);
        ...
        ERROR_CODE_HTTP_STATUS_MAP.put(INVALID_REGISTRATION_INFORMATION, BAD_REQUEST);
        ERROR_CODE_HTTP_STATUS_MAP.put(NOTIFICATION_NOT_FOUND, NOT_FOUND);
        ERROR_CODE_HTTP_STATUS_MAP.put(NOTIFICATION_TYPE_ALREADY_EXISTS, BAD_REQUEST);
